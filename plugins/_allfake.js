...
handler.all = async function (m) {
	...
	try {
		...
		// Fake 🤥
		global.ftroli = { key: { remoteJid: 'status@broadcast', participant: '0@s.whatsapp.net' }, message: { orderMessage: { itemCount: 7777777, status: 1, surface: 1, message: wm, orderTitle: wm, sellerJid: '0@s.whatsapp.net' } } }
        ...
        global.fvn = {
            ...
            participant: `0@s.whatsapp.net`, ...(m.chat ? 
            { remoteJid: "status@broadcast" } : {}) },
            message: { "liveLocationMessage": { "title": "By FaiRuzz","h": wm, 'jpegThumbnail': fs.readFileSync('./thumbnail.jpg')}}
           }
